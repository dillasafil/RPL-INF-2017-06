	...
	echo'<div class="panel panel-info col-md-6 col-md-offset-3" style="padding:0px;">
			...
			<div class="panel-footer">
				...
				<span class="pull-right">
					<a href="#edit" data-toggle="modal" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
